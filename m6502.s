...
ADRGAY: .WORD GIVAYF            ;STORE HERE THE ADDR OF THE
.ENDIF
...
FUNDSP: .WORD SGN
        ...
        .WORD ABS
.IF ROMSW=0
USRLOC: .WORD FCERR             ;INITIALLY NO USER ROUTINE.
.ENDIF
.IF ROMSW<>0
USRLOC: .WORD USRPOK
.ENDIF
...
.IF ADDPRC=0
NZ0999: .BYTE 145       ; 99999.9499
        .BYTE 67
        .BYTE 79
        .BYTE 248
NZ9999: .BYTE 148       ; 999999.499
        .BYTE 116
        .BYTE 35
        .BYTE 247
NZMIL:  .BYTE 148       ; 10^6.
